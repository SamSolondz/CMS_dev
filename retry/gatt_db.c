...
uint8_t bg_gattdb_data_attribute_field_21_data[4]={0x30,0x78,0x30,0x30,};
...
uint8_t bg_gattdb_data_attribute_field_6_data[3]={0x53,0x55,0x4e,};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8004,.permissions=0x802,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_21},
    ...
    {.uuid=0x8006,.permissions=0x802,.caps=0xffff,.datatype=0x07,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_24},
};
